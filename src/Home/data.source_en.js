  ...
  titleWrapper: {
    ...
    children: [
      { name: 'title', children: 'Operation process', className: 'title-h1' },
      {
        ...
        children: (
          <div>
            一 Project information collection - Community voting aid objects - aid amount voting (DOF fund payment / community donation payment) - docking with donors / institutions / regions - project implementation<br />

            二 declaration of donor information - authenticity of foundation audit - launch of official website - Community voting aid method - DOF fund counterpart / institution / Region - Implementation of project implementation<br />

            三 Project owner application - Submission materials - DOF review materials - risk assessment - investment assessment - investment grade content publicity - user reference investment<br />
            四 The recipient provides the information of the project, and the DOF provides the audit and help, and publicizes it with the official website for other users to check, so as to prevent the loss of assets.
          </div>
        ),
        className: 'title-content',
      },
